    ...
    <Fragment>
      <div className="container">
        <div id="contant">
          ...
          <ul className="policy-list">
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Sayana Worldverse Private limited,
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Sayana Worldverse, accessible
                from
                <p>https://sayanaworldverse.com</p>
              </p>  
            </li>
            <li>
              <p>
          ...
          <ul className="policy-list">
            <li>
              <p>By email: support@sayanaworldverse.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:
                <p>https://sayanaworldverse.com/contact</p>
              </p>
            </li>
          </ul>
        </div>
