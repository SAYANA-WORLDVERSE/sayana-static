    ...
    <Fragment>
      <div className="container">
        <div id="contant">
          ...
          <ul className="policy-list">
            <li>
              <p>By email:  suport@sayanaworldverse.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website: [Abhi's Ganga, 1st Floor,
                Vittal Rao Nagar Rd, Madhapur, Hyderabad, Telangana
                500081](Abhi's Ganga, 1st Floor, Vittal Rao Nagar Rd, Madhapur,
                Hyderabad, Telangana 500081)
              </p>
            </li>
          </ul>
